...
#
# Input:
#   data/clean/forest/uganda_sim_Y_bin80_w_pred.csv
#
# Output:
#   data/clean/forest/assumption_stability.csv
# =============================================================================
...
# columns (R0, R1, ...) produced by 01_data_construction/07_evaluate_predictors.R.
# -----------------------------------------------------------------------------
...
out_csv <- "data/clean/forest/assumption_stability.csv"
