...
imagery <- st_read("data/clean/forest/shapefiles/imagery_boundary.gpkg", quiet = TRUE)

# Districts
districts <- st_read("data/clean/forest/shapefiles/districts.gpkg", quiet = TRUE)
...
out_zoom <- "figures/forest/map.pdf"
