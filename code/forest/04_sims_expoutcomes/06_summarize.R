...
#
# Input:
#   data/interim/forest/binary_expoutcomes/{benchmark,ppio,ppiv,rsv}/*.Rds
#
# Output:
#   data/clean/forest/sims_expoutcomes.csv
# =============================================================================
...
alpha   <- 0.05
out_dir <- file.path("data/interim/forest", "binary_expoutcomes")
...
out_path <- "data/clean/forest/sims_expoutcomes.csv"
