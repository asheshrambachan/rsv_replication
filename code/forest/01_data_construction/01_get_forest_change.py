...
Output:
- Downloaded tiles: data/raw/forest/forest_cover/hansen_tiles/<country>/*.tif
- Processed data: data/raw/forest/forest_cover/<country>_forest_cover_<year>_<resolution>deg.csv
"""
