...
#   05_summarize.R — summarize results across replicates; save to data/clean/forest/
#
...
source("code/forest/03_sims_noexpoutcomes/01_params.R")
source("code/forest/03_sims_noexpoutcomes/02_plugin.R")
source("code/forest/03_sims_noexpoutcomes/03_calibrate.R")
source("code/forest/03_sims_noexpoutcomes/04_rsv.R")
source("code/forest/03_sims_noexpoutcomes/05_summarize.R")
