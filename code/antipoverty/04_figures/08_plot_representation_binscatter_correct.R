...
data <- read.csv("data/clean/antipoverty/representations_correct_seed42.csv")

for (S_name in c("Ssynth", "Sreal")){
  ...
  output_path <- sprintf("output/figures/antipoverty_representation_binscatter/%s_correct_seed42.jpeg", S_name)
