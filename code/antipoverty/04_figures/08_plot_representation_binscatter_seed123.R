...
data <- read.csv("data/clean/antipoverty/representations_seed123.csv")
...
for (S_name in c("Ssynth", "Sreal")){
  ...
  output_path <- sprintf("output/figures/antipoverty_representation_binscatter/%s_seed123.jpeg", S_name)
