...
source("code/poverty/02_analysis/07_rsv_realD_synthS_gate_sample.R")
source("code/poverty/02_analysis/08_rsv_realD_realS_gate_sample.R")
source("code/poverty/02_analysis/09_benchmark_realD_gate_sample.R")
...
source("code/poverty/03_outputs/plot_realD_denominator_gate_sample.R")
source("code/poverty/03_outputs/plot_realD_te_gate_sample.R")

source("code/poverty/03_outputs/plot_realD_denominator_both_samples.R")
source("code/poverty/03_outputs/plot_realD_te_both_samples.R")
