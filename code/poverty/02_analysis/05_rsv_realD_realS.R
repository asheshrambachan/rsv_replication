...
parser <- ArgumentParser(description = "Estimate RSV: Real Treatment Effects & Real Sample Definitions")
...
run_one <- function(Y_var) {
  ...
  # Export Results
  output_path <- sprintf("data/poverty/interim/rsv_realD_realS_%s.rds", Y_var)
