...
source("code/smartcards/01_data_construction/01_study_data.R")
source("code/smartcards/01_data_construction/02_satellite_features.R")
source("code/smartcards/01_data_construction/03_merge_and_pca.R")
source("code/smartcards/01_data_construction/04_shapefiles.R")
