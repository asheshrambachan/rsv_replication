...
#
# Inputs:
#   data/interim/smartcards/base_data.Rds
#   data/interim/smartcards/viirs.Rds
#   data/interim/smartcards/satellite_features.Rds
#   data/interim/smartcards/centroid_coords.Rds
#
# Output: data/clean/smartcards/data.csv
# =============================================================================
...
base_data          <- readRDS("data/interim/smartcards/base_data.Rds")
viirs_annual       <- readRDS("data/interim/smartcards/viirs.Rds")
satellite_features <- readRDS("data/interim/smartcards/satellite_features.Rds")
centroid_coords    <- readRDS("data/interim/smartcards/centroid_coords.Rds")
...
out_path <- "data/clean/smartcards/data.csv"
