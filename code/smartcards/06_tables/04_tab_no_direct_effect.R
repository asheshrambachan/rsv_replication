...
#
# Input:  data/clean/smartcards/assumption_no_direct_effect.csv
# Output: tables/smartcards/tab_no_direct_effect.tex
# ==============================================================================

ks <- read.csv("data/clean/smartcards/assumption_no_direct_effect.csv")
