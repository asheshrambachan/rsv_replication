...
# ==============================================================================
# Assumption 2(i) -- Stability: KS table (S definition)
#
# Tabulates the KS test results from 02_assumption_tests/02_stability_S.R.
# Reports F(R_PC1 | S=e, D=0, Y=y) vs F(R_PC1 | S=o, D=0, Y=y) for each
# outcome and level of Y using the non-overlapping sample definition S.
# Buffer Mandals (2011) appear only in S=e. Failure to reject supports
# R ⊥ S | D=0, Y.
#
# See 03_tab_stability_Stilde.R for the analogous table using the overlap
# design Stilde, where Buffer Mandals appear in both Stilde=e and Stilde=o.
#
# Input:  data/clean/smartcards/assumption_stability_S.csv
# Output: tables/smartcards/tab_stability_S.tex
# ==============================================================================

ks <- read.csv("data/clean/smartcards/assumption_stability_S.csv")
...
out_path <- file.path(tables_dir, "tab_stability_S.tex")
