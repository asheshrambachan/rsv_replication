...
#
# Input:
#   data/interim/smartcards/sims_noexpoutcomes/{calibrate,rsv}/*.Rds
#
# Output:
#   data/clean/smartcards/sims_noexpoutcomes.csv
# =============================================================================
...
alpha   <- 0.05
out_dir <- "data/interim/smartcards/sims_noexpoutcomes"
...
out_path <- "data/clean/smartcards/sims_noexpoutcomes.csv"
