...
source("code/smartcard/06_tables/01_tab_summary_stats.R")
source("code/smartcard/06_tables/02_tab_stability.R")
source("code/smartcard/06_tables/03_tab_no_direct_effect.R")
source("code/smartcard/06_tables/04_tab_relevance.R")
source("code/smartcard/06_tables/05_tab_rsv.R")
source("code/smartcard/06_tables/06_tab_estimators_jtest.R")
