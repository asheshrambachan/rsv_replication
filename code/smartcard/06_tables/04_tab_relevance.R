...
#
# Reads:  data/clean/smartcard/empirical_relevance.csv  (from 04_empirical/04_summarize_relevance.R)
# Saves:  tables/smartcard/empirical/{sample}/tab_relevance.tex
# ==============================================================================
...
rel_data <- read.csv("data/clean/smartcard/empirical_relevance.csv")
...
for (sample in c("full", "nospillover")) {
  ...
  out_dir <- file.path("tables/smartcard/empirical", sample)
