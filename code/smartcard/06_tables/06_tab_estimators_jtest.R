...
#
# Reads:  data/clean/smartcard/empirical_results.csv  (from 04_empirical/02_summarize.R)
# Saves:  tables/smartcard/empirical/{sample}/tab_estimators_jtest.tex
# ==============================================================================
...
all_results <- read.csv("data/clean/smartcard/empirical_results.csv")
