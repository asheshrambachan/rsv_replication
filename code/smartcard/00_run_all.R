...
source("code/smartcard/01_data_construction/00_run_all.R")
source("code/smartcard/02_assumption_tests/00_run_all.R")
source("code/smartcard/03_sims_noexpoutcomes/00_run_all.R")
source("code/smartcard/04_empirical/00_run_all.R")
source("code/smartcard/05_figures/00_run_all.R")
source("code/smartcard/06_tables/00_run_all.R")
