...
#
# Output: data/interim/smartcard/base_data.Rds
# =============================================================================
...
study_data <- read_dta(
  "data/raw/smartcard/muralidharanetal_replication_package/balance-for-ap-mandal-comparison.dta",
...
out_path <- "data/interim/smartcard/base_data.Rds"
