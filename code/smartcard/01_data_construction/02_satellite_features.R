...
#
# Input:  data/clean/smartcard/shapefiles/shrids.gpkg
# Output: data/interim/smartcard/viirs.Rds
...
out_path <- "data/interim/smartcard/viirs.Rds"
...
shrids    <- st_read("data/clean/smartcard/shapefiles/shrids.gpkg", quiet = TRUE)
...
out_path <- "data/interim/smartcard/centroid_coords.Rds"
dir.create(dirname(out_path), recursive = TRUE, showWarnings = FALSE)
...
out_path <- "data/interim/smartcard/satellite_features.Rds"
