...
#
# Output: data/interim/smartcard/empirical/{full,nospillover}/{Y_var}.Rds
# =============================================================================
...
data <- fread("data/clean/smartcard/smartcard_data.csv") %>%
  mutate(
    S = case_when(
...
out_dir <- "data/interim/smartcard/empirical/full"
...
out_dir <- "data/interim/smartcard/empirical/nospillover"
dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)
