...
#
# Input:  data/clean/smartcard/empirical_results.csv
# Output: figures/smartcard/empirical/{full,nospillover}/te/
# =============================================================================
...
all_results <- fread("data/clean/smartcard/empirical_results.csv")

# Produce figures for both the main sample and the no-spillover robustness check
for (sample in c("full", "nospillover")) {
  output_dir <- file.path("figures/smartcard/empirical", sample, "te")
