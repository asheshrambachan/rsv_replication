...
#
# Input:  data/interim/smartcard/binary_noexpoutcomes/summary_stats_{estimator}.Rds
# Output: figures/smartcard/binary_noexpoutcomes/{outcome}/
# =============================================================================
...
all_results <- fread("data/clean/smartcard/sims_noexpoutcomes.csv")
...
for (outcome in OUTCOMES) {
  ...
  figures_dir <- file.path("figures/smartcard/binary_noexpoutcomes", outcome_lc)
...
cat("\nFigures saved to: figures/smartcard/binary_noexpoutcomes/{outcome}/\n")
