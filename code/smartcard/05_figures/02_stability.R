...
# Output: figures/smartcard/stability/[y_cons|y_lowinc|y_midinc]/
# =============================================================================
...
for (d in c(0,1)){
  for (y in c(0,1)){
    for (Y_var in c("Ycons","Ylowinc", "Ymidinc")){
      ...
      output_path <- sprintf("figures/smartcard/stability/%s/smartcard_r_dist_d%s_%s%s.pdf", y_var_snake, d, y_var_snake, y)
