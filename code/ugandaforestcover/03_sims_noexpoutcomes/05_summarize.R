...
#
# Input:
#   data/interim/ugandaforestcover/sims_noexpoutcomes_{outcome}/{plugin,calibrate,rsv}/*.Rds
#
# Output:
#   data/clean/ugandaforestcover/sims_noexpoutcomes.csv
# =============================================================================
...
out_path <- "data/clean/ugandaforestcover/sims_noexpoutcomes.csv"
