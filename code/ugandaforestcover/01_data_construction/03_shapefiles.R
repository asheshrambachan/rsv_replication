...
#
# Inputs:
#   data/raw/ugandaforestcover/jayachandran_et_al_replication_files/CashForCarbon_full/
#     BaselineShapesWGS84_dissolved.shp
#   data/raw/ugandaforestcover/uga_admin_boundaries.shp/uga_admin2.shp
#
# Outputs:
#   data/clean/ugandaforestcover/shapefiles/imagery_boundary.gpkg
#   data/clean/ugandaforestcover/shapefiles/districts.gpkg
# =============================================================================
...
dir.create("data/clean/ugandaforestcover/shapefiles", recursive = TRUE, showWarnings = FALSE)
...
imagery <- st_read(
  "data/raw/ugandaforestcover/jayachandran_et_al_replication_files/CashForCarbon_full/BaselineShapesWGS84_dissolved.shp",
  quiet = TRUE
) |> st_transform(4326)

st_write(imagery, "data/clean/ugandaforestcover/shapefiles/imagery_boundary.gpkg",
...
st_write(admin2, "data/clean/ugandaforestcover/shapefiles/districts.gpkg",
