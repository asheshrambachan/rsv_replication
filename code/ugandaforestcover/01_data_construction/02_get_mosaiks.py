...
# Paths
DATA_DIR = Path("data/raw/ugandaforestcover/mosaiks_features")
...
Notes:
    ...
    print(f"Output: data/raw/ugandaforestcover/mosaiks_features/{country}_mosaiks_features_{args.resolution}deg.csv")
    print()
