...
bash code/ugandaforestcover/01_data_construction/00_run_all.sh

Rscript -e 'source("code/ugandaforestcover/02_assumption_tests/00_run_all.R")'
Rscript -e 'source("code/ugandaforestcover/03_sims_noexpoutcomes/00_run_all.R")'
Rscript -e 'source("code/ugandaforestcover/04_sims_expoutcomes/00_run_all.R")'
Rscript -e 'source("code/ugandaforestcover/05_figures/00_run_all.R")'
Rscript -e 'source("code/ugandaforestcover/06_tables/00_run_all.R")'
